...
const PokemonPage = ({ previous, next }) => {
  ...
  if (!pokemon) return <ErrorMessage error="Pokémon not found" />;
  ...
  return (
    <>
      ...
      <div className={`pokemon-page pokemon-type-${type?.name || 'unknown'}`}>
        <div
          className="pokemon-image"
          style={{
            backgroundImage: `url(${
              pokemon.sprites.front_default || 'default-image.jpg'
            })`,
          }}
        />
